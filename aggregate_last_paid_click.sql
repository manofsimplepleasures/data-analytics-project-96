...
last_paid_click AS (
    SELECT DISTINCT ON (visitor_id)
        ...
        visit_ts
    FROM paid_sessions
    ORDER BY visitor_id, visit_ts DESC, utm_source, utm_campaign
),
...
attributed_leads AS (
    ...
    INNER JOIN leads AS l
        ...
        AND l.created_at <= lpc.visit_ts + INTERVAL '30 days'
...
debug_sessions AS (
    ...
    WHERE source = 'vk'
        ...
        AND medium NOT IN ('cpc', 'cpp', 'cpa', 'social')
...
LEFT JOIN debug_sessions AS ds
